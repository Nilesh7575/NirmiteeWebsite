                ...
                <div className="footer-main-div">
                    <div className="footer-inner-div">
                        ...
                        <div className="Footer_social">
                            <div>
                                <a href="https://www.facebook.com/nirmitee.io/" target="_blank" rel="noopener noreferrer"><FacebookIcon className="social-icon" /></a>
                            </div>
                            <div>
                                <a href="https://www.linkedin.com/company/nirmitee/" target="_blank" rel="noopener noreferrer"><LinkedInIcon className="social-icon" /></a>
                            </div>
                            <div>
                                <a href="https://twitter.com/nirmitee_io/" target="_blank" rel="noopener noreferrer"><TwitterIcon className="social-icon" /></a>
                            </div>
                            <div>
                                <a href="https://instagram.com/nirmitee_io" target="_blank" rel="noopener noreferrer"><InstagramIcon className="social-icon" /></a>
                            </div>
                        </div>
                    </div>
                    <div className="footer-inner-div">
