              ...
              <div className="dropdown1-content">
                ...
                <div className="row">
                  ...
                  <div className="column">
                    ...
                    <Link to="/awsServerlessArchitecture">
                  ...
                  <div className="column">
                    <h4>INTEGRATIONS</h4>
                    <Link to="/phonepeSwitchIntegrations">
                      Phonepe-switch Intergrations
                    </Link>
                    <Link to="paytmMiniAppsIntegrations">
                      Paytm Mini-apps Integrations
                    </Link>
                    <Link to="/paymentGatewayIntegrations">
...
transition={{style:'spring', stiffness:100}}>Link2</motion.p> </a>
  ...
  <button class="dropbtn">
    <p>Services</p>
          ...
          <button onClick={props.toggle}>TALK TO OUR EXPERT</button>
        </motion.div>
